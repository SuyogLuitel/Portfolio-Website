...
const Archive = () => {
  ...
  return (
    <div className="bg-slate-900 w-full h-screen p-32">
      ...
      <div className="mt-20">
        <div className="flex justify-between items-center text-slate-200 leading-normal text-lg font-medium border-b border-slate-800 pb-2">
          ...
          <div className="flex-[2] text-center">Built with</div>{" "}
          <div className="flex-1 text-center">Link</div>
        </div>

        <div className="flex justify-between items-center text-slate-200 leading-normal text-lg font-medium my-5 border-b border-slate-800 pb-2">
          ...
          <div className="flex-[2] flex items-center gap-3 justify-center flex-wrap">
