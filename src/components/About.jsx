...
const About = () => {
  return (
    <div className="text-[#94A3B8] text-lg font-medium flex flex-col gap-8">
      <p>
        ...
        <span className="text-slate-200">start-up</span>, a{" "}
        <span className="text-slate-200">huge corporation</span>, and a{" "}
        <span className="text-slate-200">digital product studio</span>.
      </p>
      <p>
        My main focus these days is building accessible user interfaces for our
        customers at <span className="text-slate-200">Klaviyo</span>. I most
        ...
        <span className="text-slate-200">online video course</span> that covers
      ...
      <p>
        ...
        <span className="text-slate-200">Korokseeds.</span>
      </p>
    </div>
  );
};
